            ...
            <div class="table-responsive">
                <table class="table table-hover table-condensed table-bordered">
                    <tr>
                        ...
                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#updateusername">Update</button></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><?php echo $email ?></td>
                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#updateemail">Update</button></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>hidden</td>
                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#updatepassword">Update</button></td>
                    </tr>
                </table>
            </div>
        </div>
